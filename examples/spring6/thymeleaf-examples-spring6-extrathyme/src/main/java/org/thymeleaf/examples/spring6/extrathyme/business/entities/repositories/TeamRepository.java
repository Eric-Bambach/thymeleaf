...
public class TeamRepository {
    ...
    public List<Team> findAllTeams() {
        ...
        teams.add(new Team("KCS", "Kroger Crushers", 100, 22, 10, 4));
        ...
        teams.add(new Team("OPS", "Orange Pirates", 40, 9, 11, 16));
        ...
        teams.add(new Team("LLS", "Lemon Legions", 30, 7, 7, 22));
        teams.add(new Team("WWS", "Wal-Mart Waltons", 30, 6, 7, 23));
        teams.add(new Team("MMS", "Meijer Mashers", 30, 5, 7, 24));
        teams.add(new Team("PPS", "Publix Purveyors", 30, 4, 7, 25));
